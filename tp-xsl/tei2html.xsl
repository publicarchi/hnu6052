  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <meta name="author" content="Lou Burnard Consulting, Emmanuel Chateau-Dutier" />
      ...
      <body>
        <main>
          <header>
            <nav>
              <ul>
                <li><a href="plan-de-cours/" aria-current="page">Plan de cours</a></li>
                <li><a href="index.html" >EDN6101 Édition critique avec la TEI</a></li>
          ...
          <footer>
            <nav>
              <ul>
                <li>CC BY-NC-SA Antoine Fauchié et Emmanuel Château-Dutier 2021</li>
              </ul>
            </nav>
          </footer>
        </main>
